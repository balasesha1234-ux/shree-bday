        ...
        <div className="grid grid-cols-4 gap-3 sm:gap-5 md:gap-7 w-full">
          {units.map((unit, index) => (
            ...
            >
              ...
              <span className="mt-3.5 sm:mt-4 px-4 py-1 rounded-full bg-white/10 border border-white/20 text-[10px] sm:text-xs md:text-sm font-space tracking-[0.25em] text-pink-200 font-extrabold uppercase text-center backdrop-blur-md shadow-md group-hover:border-amber-300/60 group-hover:text-amber-200 transition-colors">
                {unit.label}
              </span>
            </motion.div>
          ))}
