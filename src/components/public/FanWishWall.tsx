...
export const FanWishWall: React.FC = () => {
  ...
  return (
    <section id="wish-wall" className="w-full max-w-6xl mx-auto px-4 py-16">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-10">
        <div>
          <span className="text-xs font-fredoka uppercase tracking-widest text-[#FF4D8D] font-bold">
            COMMUNITY CELEBRATION 🌸
          </span>
          <h2 className="text-3xl sm:text-4xl font-fredoka font-bold text-gray-800">
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#FF4D8D] hover:bg-[#FF2D78] text-white font-fredoka font-semibold text-sm shadow-pop hover:scale-105 active:scale-95 transition-all"
        >
        ...
        {wishes.map((wish, index) => {
          ...
          return (
            <motion.div
              ...
              className="relative p-6 rounded-3xl bg-white shadow-pop border border-pink-100 flex flex-col justify-between hover:shadow-lg transition-shadow duration-300"
            >
              <div className="flex items-center justify-between border-b border-pink-50 pb-3 mb-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h4 className="font-fredoka font-bold text-gray-800 text-sm">
                      {wish.name}
                    </h4>
                    {wish.city && (
              ...
              <div className="flex items-center justify-between pt-3 border-t border-pink-50 text-xs font-quicksand text-gray-400">
                ...
                <button
                  ...
                  className={'flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold transition-all ' + (isLiked ? 'bg-pink-100 text-[#FF4D8D]' : 'bg-gray-50 text-gray-500 hover:bg-pink-50 hover:text-[#FF4D8D]')}
                >
